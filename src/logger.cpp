...
namespace nl
{
    ...
    void Logger::emitMsg(LogLevel level, const std::string& message)
    {
        if (level >= m_minLevel)
        {
            ...
            static std::array<const char*, 5> s_prefixes = {{"nl trace: ", "nl debug: ", "nl info:  ", "nl warn:  ", "nl err:   "}};
    ...
    LogLevel Logger::getMinLogLevel()
    {
        ...
        const char* envVar = getenv("NL_LOG_LEVEL");
    ...
    {
        const char* envVar = getenv("NL_LOG_FILE");
